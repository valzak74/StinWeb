#pragma checksum "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Отчеты\Журнал.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "77140dd29c0818115fe0e7940231afa45437eb49"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"77140dd29c0818115fe0e7940231afa45437eb49", @"/Views/Отчеты/Журнал.cshtml")]
...
<ul id=""div-popover"" style=""display:none"">
    ");
#nullable restore
#line 35 "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Отчеты\Журнал.cshtml"
...
#nullable disable
            WriteLiteral("\r\n    ");
#nullable restore
#line 36 "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Отчеты\Журнал.cshtml"
...
#nullable restore
#line 42 "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Отчеты\Журнал.cshtml"
...
<script>
 ...
 ");
    ...
    //        TablePopover(e.detail.origi");
            WriteLiteral(@"nalEvent.target, e.detail.data[""IdDoc""], e.detail.data[""ВидДокумента10""]);
    //    }
    //});
    ...
    function ModalДокумент(option, idDoc, видДок10, основаниеIdDoc, основаниеВидДок10, параметр) {
        ...
        $.ajax({
            ...
            success: function (obj) {
               ");
            WriteLiteral(@" if (obj) {  // check if data is defined
                    $(""#docContent"").html(obj);
