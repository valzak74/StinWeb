#pragma checksum "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Отчеты\ЖурналДоставки.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ca043c1d719d64b73b99cd55e584e7028a99ab56"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ca043c1d719d64b73b99cd55e584e7028a99ab56", @"/Views/Отчеты/ЖурналДоставки.cshtml")]
...
<script>
    ...
    document.addEventListener(""rowdblclick"", e => {
        if (e.detail.grid.name == ""gridЖурналДоставки"") {
            ...
            Полу");
            WriteLiteral(@"читьВидДокумента10(""Просмотр"");
        }
    });
    ...
    $(""#видДокумента"").on(""change"", function () {
        ...
        if (option == ""Просмотр"") {
            ...
            WriteLiteral(@" else { //Ввод на основании
            if (ВидДок == ""10080"") {
                //ПеремещениеИзделий
...
");
            WriteLiteral("                DisableBusyScreen();\r\n            },\r\n            error: function (e, v, f) {\r\n                alert(\"ошибка выполнения!\");\r\n            }\r\n        });\r\n    });\r\n\r\n</script>\r\n");
        }
