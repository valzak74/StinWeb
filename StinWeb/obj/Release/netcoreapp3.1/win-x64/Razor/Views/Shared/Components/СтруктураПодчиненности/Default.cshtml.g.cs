#pragma checksum "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Shared\Components\СтруктураПодчиненности\Default.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "855107960dbdaaa7518ab2afcf0f48128a8ffdec"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"855107960dbdaaa7518ab2afcf0f48128a8ffdec", @"/Views/Shared/Components/СтруктураПодчиненности/Default.cshtml")]
    ...
    $('#структураПодчиненности').on('show.bs.modal', function (e) {
        if (($(""#структураПодчиненностиКореньIdDoc"").val() != undefined) && ($(""#структураПодчиненностиКореньIdDoc"").val() != """")) {
            $('#treeСтруктураПодчиненности').jstree({
                ""plugins"": [""core"", ""themes"", ""search"", ""grid""],
                ""search"": {
            ...
            WriteLiteral(@"   ],
                ...
                'core': {
                    ...
                    'data': {
                        'url': function (node) {
                            return node.id === '#' ?
                                'СтруктураПодчиненности?idDoc=_1WJCND__' :
