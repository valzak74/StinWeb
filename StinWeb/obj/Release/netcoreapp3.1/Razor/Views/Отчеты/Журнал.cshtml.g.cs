#pragma checksum "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Отчеты\Журнал.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "939d5b764ded4eace90e556d9878900437940610"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"939d5b764ded4eace90e556d9878900437940610", @"/Views/Отчеты/Журнал.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n    ");
#nullable restore
#line 33 "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Отчеты\Журнал.cshtml"
...
#nullable restore
#line 39 "C:\Users\Валентин\source\repos\StinWeb\StinWeb\Views\Отчеты\Журнал.cshtml"
 ...
 ");
    ...
    $('#reportrange').on('apply.daterangepicker', function (ev, picker) {
        ...
        gridЖурнал.set({
            ...
            query: ""startDate="" + picker.startDate.toISOString()
    ...
    document.addEventListener(""rowdblclick"", e => {
        if (e.detail.grid.name == ""gridЖурналОбщий"") {
            TablePopover(e.detail.originalEve");
            WriteLiteral(@"nt.target, e.detail.data[""IdDoc""], e.detail.data[""ВидДокумента10""]);
        }
    });

    function ModalДокумент(option, idDoc, видДок10, основаниеIdDoc, основаниеВидДок10) {
        EnableBusyScreen()
        $.ajax({
