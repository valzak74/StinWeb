...
{
    public class ФормаНаДиагностику
    {
        ...
        public List<тчНаДиагностику> ТабличнаяЧасть { get; set; }
        public ФормаНаДиагностику()
        {
            this.Общие = new ОбщиеРеквизиты();
            this.ТабличнаяЧасть = new List<тчНаДиагностику>();
        }
        public ФормаНаДиагностику(ТипыФормы типФормы)
        {
            this.Общие = new ОбщиеРеквизиты();
            this.ТабличнаяЧасть = new List<тчНаДиагностику>();
            this.Общие.ТипФормы = типФормы;
        }
        public ФормаНаДиагностику(ТипыФормы типФормы, List<тчНаДиагностику> табЧасть)
        {
            this.Общие = new ОбщиеРеквизиты();
            this.Общие.ТипФормы = типФормы;
            this.ТабличнаяЧасть = табЧасть ?? new List<тчНаДиагностику>();
        }
    }
    public class тчНаДиагностику
    {
